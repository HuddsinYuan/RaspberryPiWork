...
if __name__ == "__main__":
    ...
    for x in range(0,60):
        for y in range(0,120):
            a = fd.read(1)
            print a
            mc.setBlock(u,v,z,block.AIR)
            if a == '0':
                mc.setBlock(u,v,z,block.ICE)
            elif a == '1':
                mc.setBlock(u,v,z,block.CLAY)
            elif a == '2':
                mc.setBlock(u,v,z,block.COAL_ORE)
            u = u+1
        z = z+1
        u = 0;
